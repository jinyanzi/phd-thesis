...
% To ensure the capability of processing a large amount of data, our methods are end-to-end without human input and run in real-time. 
...
% Chapter \ref{chp:gp-ukf}describes learning scene-specific motion model to make up for the simplified linear motion model in chapter \ref{chp:tracker}.
