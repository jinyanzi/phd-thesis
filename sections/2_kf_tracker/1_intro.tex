...
% In principle, computer vision promises an alternative that is both highly descriptive and fully automatic, using existing, arbitrary-perspective traffic surveillance video. 
